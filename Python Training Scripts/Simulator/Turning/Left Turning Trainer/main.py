...
class CustomImageDataset(Dataset):
    def __init__(self, filePath, transform=None, target_transform =None):
        ...
        for idx in range(int(self.data.__len__()/(steeringAngleByteSize*numberOfDataPointsStored))):
            unmodifiedCameraImage = cv.imread('/home/ryan/TrainingData/simulator_left_lane_switch/photos/' + str(idx) + "-semanticOutput.png", cv.IMREAD_GRAYSCALE)
...
dataset = CustomImageDataset("/home/ryan/TrainingData/simulator_left_lane_switch/turningData.bin")
'''
